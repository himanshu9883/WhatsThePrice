...
public class ThingsAdapter extends RecyclerView.Adapter<ThingsAdapter.ViewHolder> {
    ...
    public ThingsAdapter(Context mContext, List<Post> mPosts) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        ...
        product=prefs.getString("postProduct",null);
        return new ThingsAdapter.ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull final ThingsAdapter.ViewHolder viewHolder, int i) {
